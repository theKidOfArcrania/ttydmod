...
static int evt_gameover[] = {
    ...
    CALL_CPP_SYNC(PTR(&evt_snd_sfxon_3d), PTR("SFX_STG7_CANNON_SYS_ACTIVE2"),
        LW(0), LW(1), LW(2)) // LMAO this was reused for fracktail.
...
// arg0: key
// arg1: ret
const char FLAG_ENCRYPTED[] = {0x2f,0x16,0x11,0x1d,0x09,0x5a,0x56,0x11,0x3a,0x3e,0x06,0x1d,0x16,0x45,0x7e,0x4c,0x7d,0x05,0x43,0x07,0x08,0x7e,0x10,0x52,0x12,0x02,0x42,0x59,0x03,0x5c};
