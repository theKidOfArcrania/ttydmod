#ifndef __EVT__EVT_NPC
#define __EVT__EVT_NPC
...
USERFUNC_DEF(evt_npc_status_onoff);
USERFUNC_DEF(evt_npc_glide_position);
USERFUNC_DEF(evt_npc_reverse_ry);
USERFUNC_DEF(evt_npc_set_tribe);
