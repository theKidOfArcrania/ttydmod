...
//#define Goto(EVT_SOURCE)                EVT_CMD(EVT_OPC_GOTO, EVT_SOURCE),
...
#define IF_FLOAT_LE(var1, var2)         EVT_CMD(EVT_OPC_IFF_SMALL_EQUAL, var1, var2),
#define IF_FLOAT_GE(var1, var2)         EVT_CMD(EVT_OPC_IFF_LARGE_EQUAL, var1, var2),
...
#define IF_INT_LE(var1, var2)           EVT_CMD(EVT_OPC_IF_SMALL_EQUAL, var1, var2),
#define IF_INT_GE(var1, var2)           EVT_CMD(EVT_OPC_IF_LARGE_EQUAL, var1, var2),
...
#define MO_READ_INT2(e1, e2)            EVT_CMD(EVT_OPC_READ2, e1, e2),
#define MO_READ_INT3(e1, e2, e3)        EVT_CMD(EVT_OPC_READ3, e1, e2, e3),
#define MO_READ_INT4(e1, e2, e3, e4)    EVT_CMD(EVT_OPC_READ4, e1, e2, e3, e4),
#define MO_READ_INT_INDEXED(expr1, expr2)   EVT_CMD(EVT_OPC_READ_N, expr1, expr2),

#define MO_SET_BASE_FLOAT(ptr)          EVT_CMD(EVT_OPC_SET_READF, ptr),
#define MO_READ_FLOAT(expr)             EVT_CMD(EVT_OPC_READF, expr),
#define MO_READ_FLOAT2(e1, e2)          EVT_CMD(EVT_OPC_READF2, e1, e2),
#define MO_READ_FLOAT3(e1, e2, e3)      EVT_CMD(EVT_OPC_READF3, e1, e2, e3),
#define MO_READ_FLOAT4(e1, e2, e3, e4)  EVT_CMD(EVT_OPC_READF4, e1, e2, e3, e4),
...
// //bitwise operations
#define AND_EXPR(expr, val)             EVT_CMD(EVT_OPC_AND, expr, val),
#define AND_RAW(expr, rawVal)           EVT_CMD(EVT_OPC_ANDI, expr, rawVal),
#define OR_EXPR(expr, val)              EVT_CMD(EVT_OPC_OR, expr, val),
#define OR_RAW(expr, rawVal)            EVT_CMD(EVT_OPC_ORI, expr, rawVal),
...
#define LOAD_INT(val, expr)             EVT_CMD(EVT_OPC_GET_RAM, val, expr),
#define LOAD_FLOAT(val, expr)           EVT_CMD(EVT_OPC_GET_RAMF, val, expr),
...
#define TERMINATE_THREAD(script)             EVT_CMD(EVT_OPC_DELETE_EVT, script),
#define JUMP(ptr)                            EVT_CMD(EVT_OPC_RESTART_EVT, ptr),
#define SET_THREAD_PRIORITY(priority)        EVT_CMD(EVT_OPC_SET_PRI, priority),
#define SET_THREAD_TIME_QUANTUM(timeScale)   EVT_CMD(EVT_OPC_SET_SPD, timeScale),
#define SET_THREAD_MASK(mask)                EVT_CMD(EVT_OPC_SET_TYPE, timeScale),

#define THREAD_SUSPEND_TYPES(types)          EVT_CMD(EVT_OPC_STOP_ALL, types),
#define THREAD_RESUME_TYPES(types)           EVT_CMD(EVT_OPC_START_ALL, types),
#define THREAD_SUSPEND_TYPES_OTHER(types)    EVT_CMD(EVT_OPC_STOP_OTHER, types), 
#define THREAD_RESUME_TYPES_OTHER(types)     EVT_CMD(EVT_OPC_START_OTHER, types), 
#define THREAD_SUSPEND_TID(expr)             EVT_CMD(EVT_OPC_STOP_ID, expr),
